 ...
 */
final class Version20240220191434 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE packpersonnalise (id_typepack INT NOT NULL, Id_packperso INT AUTO_INCREMENT NOT NULL, Nom_packperso VARCHAR(255) NOT NULL, Description_pack VARCHAR(255) NOT NULL, prix DOUBLE PRECISION NOT NULL, Date DATE NOT NULL, Image VARCHAR(255) NOT NULL, INDEX IDX_A4170AFD88794DAD (id_typepack), PRIMARY KEY(Id_packperso)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE packpersonnalise ADD CONSTRAINT FK_A4170AFD88794DAD FOREIGN KEY (id_typepack) REFERENCES typepack (id_typepack)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE packpersonnalise DROP FOREIGN KEY FK_A4170AFD88794DAD');
        $this->addSql('DROP TABLE pack');
        $this->addSql('DROP TABLE packpersonnalise');
